...
import com.example.savedataproject.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main)) { v, insets ->
         ...
         sharedPreferences = this.getSharedPreferences("com.example.savedataproject",
    ...
    fun kaydet(view: View) {
        ...
        if (kullaniciIsmi == "") {
            Toast.makeText(this@MainActivity, "İsim kısmını boş bırakmayınız.", Toast.LENGTH_LONG)
                .show()
        } else {
